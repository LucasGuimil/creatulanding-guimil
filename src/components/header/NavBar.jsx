...
function NavBar() {
    return (
        <nav className="navbar navbar-expand-md mt-0 mb-2 navbar-dark fondo-oscuro">
            <div className="container-fluid justify-content-between">
                <Link className="navbar-brand p-2" to="/"><img src="/assets/images/av-logo.png" width="100px" /></Link>
